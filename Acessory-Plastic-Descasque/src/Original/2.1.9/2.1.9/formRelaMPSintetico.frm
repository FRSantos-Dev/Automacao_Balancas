...
Begin VB.Form formRelaMPSintetico 
   Caption         =   "Relatório Sintético de Matéria Prima"
   ClientHeight    =   4200
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   14055
   ...
   End
End
Attribute VB_Name = "formRelaMPSintetico"
...
Public Sub Config()
   ...
   'CURSOR NO CLIENTE FAZ O RELATORIO SER EXIBIDO MAIS RÁPIDO
    ...
    Relatorio.Titulo = "Relatório Sintético de Matéria Prima"
    Relatorio.Ativar
    RS.Close
    Unload Me
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set formRelaMPSintetico = Nothing
